        ...
        <div class="container horizontal contact-container">
            <div class="form-block w-form">
                <form id="email-form" name="email-form" data-name="Email Form" class="form" @submit="send($event)">
                    ...
                    <input type="text" class="text-field w-input" maxlength="256" name="name" placeholder="Your Name"
                        id="name" v-model="name" required />
                    <input type="text" class="text-field w-input" maxlength="256" name="email" placeholder="Your Email"
                        id="email" required v-model="email" />
                    <textarea id="message" name="message" placeholder="Your message..." maxlength="5000" v-model="message"
                        required class="text-field textarea w-input"></textarea>
                    <input type="submit" :value="(isSending) ? 'Sending...' : 'Send'" class="submit-button w-button"
                        :disabled="isSending" />
                </form>
                <div :class="(response.success) ? 'w-form-done' : 'w-form-fail'">
            ...
            <div class="social-wrapper">
                <div class="div-block-4">
                    <a href="https://github.com/kunoacc" class="social-link w-inline-block">
                    ...
                    <a href="https://linkedin.com/in/nelsonatuonwu" class="social-link w-inline-block">
                    ...
                    <a href="https://twitter.com/@blvckcoder" class="social-link w-inline-block">
                    ...
                    <a href="https://dribbble.com/blvckcoder" class="social-link w-inline-block">
